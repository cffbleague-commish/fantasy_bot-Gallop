...
Tabs: Price Prediction Board, Live Auction, Class Grades.
"""

import streamlit as st

from styles import inject_global_css
from tabs.price_prediction_board import render as render_pp_board
...
# --- Tabs ---
tab_pp_board, tab_auction, tab_grades = st.tabs([
